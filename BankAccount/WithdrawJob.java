...
public class WithdrawJob implements Runnable{
    Account acc = new Account(1000); // Creating an object of Account, setting initial balance to 1000
    public synchronized void withdraw(int amount){ // synchronized thread makes sure that only one thread can withdraw at a time
